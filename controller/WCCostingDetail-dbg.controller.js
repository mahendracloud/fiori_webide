...
sap.ui.define([
	...
	return BaseController.extend("ugiaiwui.mdg.aiw.request.controller.WCCostingDetail", {
		...
		onInit: function () {
			...
			this.getRouter().getRoute("wccosting").attachPatternMatched(this._onObjectMatched, this);
		...
		_onObjectMatched: function (oEvent) {
			...
			this.setModel(operOverview, "wcCosting");
