		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("ChangeRequestId"),
								name: oBindingContext.getProperty("CrDescription")
							};
						}
					}));
				},
			...
			assertions: Object.assign({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all ChangeRequestSet to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "ChangeRequestSet",
