		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Asset Information Workbench",
									"targetURL": "#AssetInformationWorkbench-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AssetInformationWorkbench-display": {
								"semanticObject": "AssetInformationWorkbench",
								"action": "display",
								"description": "Asset Information Workbench for Create, Copy, Change and Approve",
								"title": "Asset Information Workbench",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ugiaiwui.mdg.aiw.request",
									"url": sap.ui.require.toUrl("ugiaiwui/mdg/aiw/request")
								}
							}
						}
					}
